...
namespace Prototype.RealWorld
{
    ...
    internal class MainApp
    {
        ...
        private static void Main()
        {
            ...
            colormanager["gray"] = new Color(0, 0, 255);
            ...
            colormanager["yellowlight"] = new Color(180, 33, 47);

            colormanager["graylight"] = new Color(212, 33, 47);
            ...
            var color5 = colormanager["yellowlight"].Clone() as Color;

            var color6 = colormanager["graylight"].Clone() as Color;
